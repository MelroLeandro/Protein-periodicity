...
## [3] "Figure  3:Backbone dihedral angles in the molecular structure of trialanine (Altis 2008)."
...
## [4] "Figure  4:Refinement for a protein with $$n$$ amino acids split in $$2n+1$$ bodies, with its $$2n$$ dihedral angles identified with $$\beta_1,\cdots,\beta_{2n}$$"
...
## [6] "Figure  6:Amino acid Mises propensity distributions PHE" 
