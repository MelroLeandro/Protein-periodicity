function aminoContW2 = ForcesContW2( aminoNames, binAng)
%
...
[p nbins]=circ_vmpdf2(binAng, phi1, psi2, wphi1, wpsi2,p);
...
[p nbins] = circ_vmpdf2(binAng, psi1,phi2, wphi1,wpsi2);
[p nbins] = circ_vmpdf2(binAng, psi1,phi2, wphi1,wpsi2,p);

aminoContW2.f(2,:,:)=-log(p);

fprintf('\t\t\t\t Prossecing Grad(psi1,phi2)\n');
I = gpuArray(p);
[d1p,d2p] = imgradientxy(-log(I));
...
[p nbins]=circ_vmpdf2(binAng, psi1, phi2, wpsi1, wphi2,p);
...
save(['contData/Mises' aminoNames SbinAng '.mat'],'aminoContW2');        
end
