function aminoContW = ForcesContW3( aminoName1, aminoName2, aminoName3, binAng)
%
...
%[d1 nbins] = circ_d1vmpdf2(binAng, phi1,psi2, w1,w2,d1);

%[d2 nbins] = circ_d2vmpdf2(binAng, phi1,psi2, w1,w2);
%[d2 nbins] = circ_d2vmpdf2(binAng, phi1,psi2, w1,w2,d2);
...
%[d1 nbins] = circ_d1vmpdf2(binAng, psi1,phi2, w1,w2,d1);

%[d2 nbins] = circ_d2vmpdf2(binAng, psi1,phi2, w1,w2);
%[d2 nbins] = circ_d2vmpdf2(binAng, psi1,phi2, w1,w2,d2);
...
%[d1 nbins] = circ_d1vmpdf2(binAng, psi1,phi1, w1,w2,d1);

%[d2 nbins] = circ_d2vmpdf2(binAng, psi1,phi1, w1,w2);
%[d2 nbins] = circ_d2vmpdf2(binAng, psi1,phi1, w1,w2,d2);
